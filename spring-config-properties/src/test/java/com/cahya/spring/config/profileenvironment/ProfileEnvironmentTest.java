package com.cahya.spring.config.profileenvironment;
...
/**
 * Contoh penggunaan EnvironmentAware untuk mendapatkan profil aktif
 * pada Spring Boot.
 * Jadi pakai method getActiveProfiles() pada Environment
 * <p>
 * Dan ini contoh mengakstif 2 profil sekaligus dgn @ActiveProfiles
 * Sehingga hasil runningnya profile yang aktif adalah production dan local.
 */
